...
See
[the detailed life cycle of a Celestia transaction](https://docs.celestia.org/learn/how-celestia-works/transaction-lifecycle).

Learn how to
[submit data to Celestia’s data availability layer](https://docs.celestia.org/how-to-guides/submit-data).
