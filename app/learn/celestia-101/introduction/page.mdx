...
Celestia is the modular blockchain powering apps with full-stack control.

At its core, Celestia is a modular
...
to launch their own application or blockchain.
...
1. [Decoupling execution from consensus](https://arxiv.org/abs/1905.09274), where Celestia is only responsible for ordering
...
2. and
introducing a new primitive, [data availability sampling (DAS)](https://arxiv.org/abs/1809.09044), where DAS provides an efficient solution to the
