...
- Testnet tokens from the [Mocha faucet](https://docs.celestia.org/operate/networks/mocha-testnet#mocha-testnet-faucet)
...
func main() {
	...
	if coreGRPC != "" {
		...
		if balanceStr == "0utia" || balanceStr == "0 utia" {
			...
			fmt.Println("Faucet: https://docs.celestia.org/operate/networks/mocha-testnet#mocha-testnet-faucet")
		} else {
...
**First run:** You'll see your account address. Fund it at the [Mocha faucet](https://docs.celestia.org/operate/networks/mocha-testnet#mocha-testnet-faucet).
...
- Fund your account at the [Mocha faucet](https://docs.celestia.org/operate/networks/mocha-testnet#mocha-testnet-faucet)
