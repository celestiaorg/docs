...
> **Tip:** Refer to [the ports section of this page](#ports) for information on which ports are required to be open on your machine.
...
> **Tip:** Save your config so custom values are not lost.
...
> **Tip:** After using the `config-update` command, double-check that your custom values are preserved.
