...
Tip: you can replace the core.ip with a consensus node RPC endpoint from [Mainnet Beta](/operate/networks/mainnet-beta#integrations), [Mocha testnet](/operate/networks/mocha-testnet#integrations), or [Arabica devnet](/operate/networks/arabica-devnet#integrations).
