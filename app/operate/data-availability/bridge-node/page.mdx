...
Choose between pruned mode (default) or archival mode:
...
Here is an example of initializing the bridge node on different networks:
...
Here are examples of starting the bridge node on specific networks:
