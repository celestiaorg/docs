...
This page covers observability in Fibre `{{mochaVersions['fibre-app-tag']}}`.
...
[Fibre dashboard JSON](https://github.com/celestiaorg/celestia-app/blob/{{mochaVersions['fibre-app-tag']}}/observability/docker/grafana/dashboards/fibre.json)
...
See the release's
[observability reference](https://github.com/celestiaorg/celestia-app/blob/{{mochaVersions['fibre-app-tag']}}/fibre/cmd/README.md#observability)
for more details.
