...
- Gone through [quick start and installed celestia-app](/operate/getting-started/quickstart)
...
> **Tip:** Refer to the ports section of the celestia-node troubleshooting page for information on which ports are required to be open on your machine.
