...
> **Tip:** Hermes currently doesn't support configuring Tendermint `CompatMode` in chain config. Use Hermes [v1.7.0+](https://github.com/informalsystems/hermes/releases/tag/v1.7.0), which falls back to Tendermint `CompatMode` v0.34 (compatible with Celestia).
...
- Celestia: [discord.gg/celestiacommunity](https://discord.gg/celestiacommunity)
