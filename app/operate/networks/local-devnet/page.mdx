...
> **Note**: The bridge node in this example uses `--archival` mode to avoid genesis hash configuration requirements for private networks. Remove this flag if you want to use pruning mode and have configured the genesis hash.
