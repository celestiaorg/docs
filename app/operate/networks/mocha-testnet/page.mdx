...
The table below lists the key network constants for Mocha testnet. For the live,
current on-chain values (which may differ from defaults due to governance
proposals), see [mocha.celenium.io/constants](https://mocha.celenium.io/constants).
