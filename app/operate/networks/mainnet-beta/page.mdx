...
**Important Change**: Starting from [TODO: Add version from PR #4768], bridge nodes default to pruning mode. If you need full historical data, you must use the `--archival` flag when starting your bridge node.
</Callout>
