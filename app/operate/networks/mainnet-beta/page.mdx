...
| CitizenWeb3     | -          | `api.celestia.citizenweb3.com`          | `grpc.celestia.citizenweb3.com:443`       | -                                                        |
| Easy2Stake      | -           | `celestia-lcd.easy2stake.com`           | -                                         | -                                                        |
...
| kjnodes         | -              | `celestia.api.kjnodes.com`              | `celestia.grpc.kjnodes.com:443`           | -                                                        |
| lunaroasis      | `rpc.lunaroasis.net`                    | -                    | `grpc.lunaroasis.net:443`                 | -                                                        |
| Noders Services | -          | `celestia-api.noders.services`          | -     | -                                                        |
| Numia           | -         | `public-celestia-lcd.numia.xyz`         | `public-celestia-grpc.numia.xyz`          | `wss://public-celestia-rpc.numia.xyz/websocket`          |
| P-OPS           | `rpc.celestia.pops.one`                 | `api.celestia.pops.one`                 | `grpc.celestia.pops.one`                  | -                                                        |
| Stakin          | -         | `celestia.rest.stakin-nodes.com`        | `celestia.grpc.stakin-nodes.com:443`      | -                                                        |
| deNodes         | -      | `celestia-mainnet-api.denodes.xyz`      | -   | `wss://celestia-mainnet-rpc.denodes.xyz:443/websocket`   |
