...
Celestia node's
[RPC (Remote Procedure Call) API](/api/v0.11.0-rc8-arabica-improvements).
...
Read more about shares in the [Celestia Specs](/api/v0.11.0-rc8-arabica-improvements/#share).
