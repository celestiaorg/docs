...
import fullConsensusNode from '../img/nodes/full-consensus-node.png';

Full Consensus Nodes allow you to sync blockchain history in the Celestia
Consensus Layer.

<Image img={fullConsensusNode} width={500}/>
...
Run the following command to quick-sync from a snapshot for `arabica-9`:
