...
`),s("span",W,[Y,s("span",Z,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),G,a(`
`),K,a(`
`),Q])]),s("pre",L,[s("code",null,[H,a(`
`),s("span",J,[j,s("span",z,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),X,a(`
`),$,a(`
...
`),Ys,a(`
`),Zs,a(`
`),s("span",Gs,[Ks,s("span",Qs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Ls,a(`
`),Hs])])]),Js,s("div",js,[zs,Xs,s("pre",$s,[s("code",null,[sa,a(`
