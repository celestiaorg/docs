...
`),P,a(`
`),V,a(`
`),q])])]),N,s("div",x,[R,M,s("pre",O,[s("code",null,[Y,a(`
`),s("span",U,[L,s("span",G,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),K,a(`
`),Q,a(`
`),W])]),s("pre",Z,[s("code",null,[J,a(`
`),s("span",H,[z,s("span",X,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),j,a(`
`),$,a(`
...
`),Ls,a(`
`),Gs,a(`
`),s("span",Ks,[Qs,s("span",Ws,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Zs,a(`
`),Js])])]),Hs,s("div",zs,[Xs,js,s("pre",$s,[s("code",null,[sa,a(`
