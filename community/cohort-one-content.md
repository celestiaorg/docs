...
- **Monday 21 November @ 11am EST / 4pm UTC / 5pm CEST**
  - In this lesson, Evan Forbes will teach us about the Quantum Gravity Bridge
    (Blobstream) and [layer 2s](https://blog.celestia.org/celestiums).
    Blobstream proves that some data was posted on Celestia.
    Rollups use the this bridge to provide strong data
    availability guarantees for block data at a fraction of
...
- Building apps in the Cosmos
  ...
  - _Convert custom Cosmos SDK chains and CosmWasm Smart Contracts into
    neatly packaged Typescript modules that can be published to npm and
    brought into frontend projects._
