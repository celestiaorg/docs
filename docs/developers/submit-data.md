...
- [blob.Submit](/api/v0.11.0-rc14/#blob.Submit)
- [state.SubmitPayForBlob](/api/v0.11.0-rc14/#state.SubmitPayForBlob)

Learn more in the [celestia-node API docs](/api/v0.11.0-rc14).
