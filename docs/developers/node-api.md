...
curl -X POST -d '{"to": "<TO_ADDRESS>",
  "amount": <AMOUNT>,
  "gas_limit": 80000}' http://<IP>:26658/transfer
```
...
curl -X POST -d '{"to": "celestia16qx7306vehyy9ndtwsy6crkmfpf7enmphvl2e2",
  "amount": 1000000,
  "gas_limit": 80000}' http://localhost:26658/transfer
```
...
You will need to have generated the `cel-key` utility using `make cel-key` to use the utility.
