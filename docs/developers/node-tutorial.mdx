...
can be found [here](../../nodes/light-node#hardware-requirements).

## Setting up dependencies

First, you will need to [install your dependencies](../../nodes/environment/) if you have not already.

## Celestia node

### Install Celestia Node

You can follow the tutorial for installing `celestia-node` [here](../../nodes/celestia-node).
