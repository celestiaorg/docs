...
description: Use Celestia Node Gateway API to submit and retrieve messages from the Celestia's DA layer.
---
...
```sh
celestia light start --core.ip https://rpc-arabica-8.consensus.celestia-arabica.com/ --gateway --gateway.addr 127.0.0.1 --gateway.port 26659 --p2p.network arabica
```
