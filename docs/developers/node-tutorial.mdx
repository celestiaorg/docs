...
```sh
celestia light start --core.ip <ip-address> --core.grpc.port <port> --gateway --gateway.ip <ip-address> --gateway.port <port>
```
...
```sh
celestia light start --core.ip <IP_address> --core.grpc.port <port> --keyring.accname <key_name> --gateway --gateway.ip localhost --gateway.port 26659
```
