...
Commit: 4c5d247de0d8f529fc5463d780959c326e256c8a
Build Date: Thu Dec 15 21:55:31 UTC 2022
...
```sh
celestia light start --p2p.network arabica-2 --core.ip <ip-address> --core.grpc.port <port> --gateway --gateway.addr <ip-address> --gateway.port <port>
```
...
```sh
celestia light start --p2p.network arabica-2 --core.ip https://limani.celestia-devops.dev --core.grpc.port 9090 --gateway --gateway.addr 0.0.0.0 --gateway.port 26659
```
...
```sh
celestia light start --core.grpc https://rpc-mocha.pops.one:9090
```
...
```sh
celestia light start --p2p.network arabica-2 --core.ip <ip-address> --core.grpc.port <port> --keyring.accname <key_name> --gateway --gateway.addr 0.0.0.0 --gateway.port 26659
```
