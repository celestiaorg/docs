...
:::danger for v0.9.0+
2. For **bridge, full, and light nodes _only_ on `celestia-node v0.9.0+`**,
...
**On `celestia-node v0.9.0+`, you can skip steps 3 and 4.**
:::

:::danger for v0.8.2 and earlier
If you run into
...
These steps are not necessary for nodes running v0.9.0 or higher.
:::
...
:::danger for v0.9.0+
For **bridge, full, and light nodes _only_ on `celestia-node v0.9.0+`**,
...
#### Bridge and full nodes v0.8.2 and lower
...
##### Example for Blockspace Race on v0.8.2 and lower
