...
If you need a list of RPC endpoints to connect to, you can check from the list [here](../mocha-testnet.md#rpc-endpoints)
...
You can create your key for your node by running the following command with the [`cel-key`](../../developers/celestia-node-key.mdx) utility:
...
* [Mocha](../mocha-testnet.md#mocha-testnet-faucet)
