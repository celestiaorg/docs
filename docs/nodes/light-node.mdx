...
```sh
celestia light start --core.ip <ip-address> --keyring.accname <key-name> --p2p.network mocha
```
...
```sh
celestia light start --keyring.accname <key_name> --core.ip <ip-address> --p2p.network arabica
```
