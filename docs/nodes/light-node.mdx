...
```sh
celestia light start --core.ip <IP_address> --core.grpc.port <port> --gateway --gateway.ip --gateway.port <port>
```
...
```sh
celestia light start --core.ip https://limani.celestia-devops.dev --core.grpc.port 9090 --gateway --gateway.ip localhost --gateway.port 26659
```
...
You can create your key for your node by running the following command with the [`cel-key`](../developers/celestia-node-key.md) utility:
...
```sh
celestia light start --keyring.accname <key_name> --core.ip <ip-address> --core.grpc.port <port> --gateway --gateway.ip <ip-address> --gateway.port <port>
```
...
```sh
celestia light start --core.grpc <ip-address>:<port> --keyring.accname <key-name>
```
...
```sh
celestia light start --core.ip <IP_address> --core.grpc.port <port> --keyring.accname <name_of_custom_key> --gateway --gateway.ip <ip-address> --gateway.port <port>
```
