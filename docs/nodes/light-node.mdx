...
View
[a video tutorial for setting up a Celestia light node](../developers/light-node-video.md).
...
[list on the Blockspace Race page](../blockspace-race#rpc-endpoints).
...
[`cel-key` utility](../../developers/celestia-node-key):
...
* [Arabica devnet](../arabica-devnet#arabica-devnet-faucet)
* [Mocha testnet](../mocha-testnet#mocha-testnet-faucet)
* [Blockspace Race testnet](../blockspace-race)
...
Follow
[the tutorial on setting up the light node as a background
process with SystemD](./systemd.md#celestia-light-node).
...
[this tutorial on submitting `PayForBlob` transactions](../../developers/node-tutorial).
