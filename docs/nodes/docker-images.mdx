...
```bash 
docker run -e NODE_TYPE=light ghcr.io/celestiaorg/celestia-node:0.6.1 celestia light start --core.ip https://rpc-mocha.pops.one:9090
```
...
```bash 
docker run -e NODE_TYPE=bridge ghcr.io/celestiaorg/celestia-node:0.6.1 celestia bridge start --core.ip https://rpc-mocha.pops.one:26657
```
...
```bash 
docker run -e NODE_TYPE=full ghcr.io/celestiaorg/celestia-node:0.6.1 celestia full start --core.ip https://rpc-mocha.pops.one:26657
```
