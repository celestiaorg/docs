...
<pre><code>
docker run -e NODE_TYPE=light -e P2P_NETWORK=arabica ghcr.io/celestiaorg/celestia-node:{arabicaVersions['node-latest-tag']} celestia light start --core.ip rpc-arabica-9.consensus.celestia-arabica.com --p2p.network arabica
</code></pre>
...
<pre><code>
docker run -e NODE_TYPE=bridge -e P2P_NETWORK=arabica ghcr.io/celestiaorg/celestia-node:{arabicaVersions['node-latest-tag']} celestia bridge start --core.ip rpc-arabica-9.consensus.celestia-arabica.com --p2p.network arabica
</code></pre>
...
<pre><code>
docker run -e NODE_TYPE=full -e P2P_NETWORK=arabica ghcr.io/celestiaorg/celestia-node:{arabicaVersions['node-latest-tag']} celestia full start --core.ip rpc-arabica-9.consensus.celestia-arabica.com --p2p.network arabica
</code></pre>
