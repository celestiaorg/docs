...
#### Run the Blobstream Orchestrator

Now that the Blobstream will be enabled for Mocha, all validators
will need to run the Blobstream orchestrator to be able to sign attestations.
To run it, please
