...
```sh
celestia bridge init --core.ip http://consensus-full-arabica-8.celestia-arabica.com/ --p2p.network arabica
```
...
```sh
celestia bridge start --core.ip http://consensus-full-arabica-8.celestia-arabica.com/ --p2p.network arabica
```
