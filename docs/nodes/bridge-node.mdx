...
```sh
celestia bridge init --core.ip rpc-arabica-9.consensus.celestia-arabica.com --p2p.network arabica
```
...
```sh
celestia bridge start --core.ip rpc-arabica-9.consensus.celestia-arabica.com --p2p.network arabica
```
