...
```sh
celestia bridge init --core.ip https://rpc-arabica-8.consensus.celestia-arabica.com/ --p2p.network arabica
```
...
```sh
celestia bridge start --core.ip https://rpc-arabica-8.consensus.celestia-arabica.com/ --p2p.network arabica
```
