...
* [Bridge node](/v0.11.0-rc8-arabica-improvements/nodes/bridge-node)
* [Full storage node](/v0.11.0-rc8-arabica-improvements/nodes/full-storage-node)
* [Light node](/v0.11.0-rc8-arabica-improvements/nodes/light-node)
...
run a local [full consensus node](../../v0.11.0-rc8-arabica-improvements/nodes/full-consensus-node) in order to download full blocks from
it. 
